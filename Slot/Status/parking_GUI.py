...
def select_image():
    ...
    if len(path) > 0:
        ...
        if panelA is None or panelB is None:
            #text 'Gambar input'
            inputText = Label(text='Input', font=('Arial',20), pady=5)
            inputText.grid(row=0, column=0)
            #text 'Gambar output'
            outputText = Label(text='            Output', font=('Arial',20), pady=5)
            ...
            panelB = Label(image=plottedImage)
            ...
            #Total slot
            slot1Text = Label(text='Total lahan parkir      ', font=('Arial', 14), pady=5)
            slot1Text.grid(row=2, column=1)
            #Occupied slot
            slot2Text = Label(text='Lahan parkir terisi    ', font=('Arial', 14), pady=5)
            slot2Text.grid(row=3, column=1)
            #Vacant slot
            slot3Text = Label(text='Lahan parkir kosong', font=('Arial', 14), pady=5)
...
# button the GUI
btn = Button(root, text="Pilih gambar input", command=select_image)
